...
public class AddWalletView extends FrameLayout implements View.OnClickListener {
	...
	private void init(@LayoutRes int layoutId) {
        ...
        if (viewPager != null) {
            ...
            viewPager.setAdapter(new IntroPagerAdapter(mContext));
        }
	}
	...
	private static class IntroPagerAdapter extends PagerAdapter {
	    ...
	    public IntroPagerAdapter(Context context) {
	        mContext = context;
            mTypeface = Typeface.createFromAsset(mContext.getAssets(), "fonts/BAHNSCHRIFT.TTF");
        }
...
//                R.mipmap.onboarding_rocket
        ...
        public Object instantiateItem(@NonNull ViewGroup container, int position) {
            ...
            ((TextView) view.findViewById(R.id.title)).setTypeface(mTypeface);
            ((TextView) view.findViewById(R.id.message)).setText(messages[position]);
            ((TextView) view.findViewById(R.id.message)).setTypeface(mTypeface);
